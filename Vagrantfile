...
Vagrant.configure("2") do |config|
    config.vm.define :laravel4 do |lv4_config|
        ...
        # livereload port
        lv4_config.vm.network :forwarded_port, guest: 35729, host: 35729, auto_correct: true
        lv4_config.vm.hostname = "tinbox.nanigans.com"
        lv4_config.vm.synced_folder "../../src/tinman", "/var/www", {:mount_options => ['dmode=777','fmode=777']}
